 ...
 */
final class Version20251130184510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE covoiturage_passagers (covoiturage_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_1B8D425662671590 (covoiturage_id), INDEX IDX_1B8D4256A76ED395 (user_id), PRIMARY KEY (covoiturage_id, user_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(60) NOT NULL, roles JSON NOT NULL, preferences_id INT DEFAULT NULL, extras_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64986CC499D (pseudo), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6497CCD6FB7 (preferences_id), UNIQUE INDEX UNIQ_8D93D649955D4F3F (extras_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_profils (user_id INT NOT NULL, profil_id INT NOT NULL, INDEX IDX_2D8E0154A76ED395 (user_id), INDEX IDX_2D8E0154275ED078 (profil_id), PRIMARY KEY (user_id, profil_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_extras (id INT AUTO_INCREMENT NOT NULL, credit NUMERIC(5, 2) DEFAULT NULL, note NUMERIC(2, 1) DEFAULT NULL, photo VARCHAR(40) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, date_premiere_immatriculation DATE NOT NULL, marque VARCHAR(50) NOT NULL, modele VARCHAR(50) NOT NULL, energie VARCHAR(50) NOT NULL, couleur VARCHAR(50) NOT NULL, nb_place_dispo INT NOT NULL, immatriculation VARCHAR(20) NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_E9E2810FBE73422E (immatriculation), INDEX IDX_E9E2810FA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE covoiturage_passagers ADD CONSTRAINT FK_1B8D4256A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6497CCD6FB7 FOREIGN KEY (preferences_id) REFERENCES preferences (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649955D4F3F FOREIGN KEY (extras_id) REFERENCES user_extras (id)');
        $this->addSql('ALTER TABLE user_profils ADD CONSTRAINT FK_2D8E0154A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_profils ADD CONSTRAINT FK_2D8E0154275ED078 FOREIGN KEY (profil_id) REFERENCES profil (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE covoiturage_passagers DROP FOREIGN KEY FK_1B8D4256A76ED395');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D6497CCD6FB7');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649955D4F3F');
        $this->addSql('ALTER TABLE user_profils DROP FOREIGN KEY FK_2D8E0154A76ED395');
        $this->addSql('ALTER TABLE user_profils DROP FOREIGN KEY FK_2D8E0154275ED078');
        ...
        $this->addSql('DROP TABLE user_extras');
